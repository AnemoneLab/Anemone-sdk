...
export class RoleManager {
     ...
     */
    async createRole(botAddress, name, description, imgUrl, suiAmount) {
     ...
     * @param suiAmount - Amount of SUI to deposit (in MIST)
     */
    async depositSui(roleId, suiAmount) {
        const tx = new Transaction();
     ...
     */
    async activateRole(roleId, botNftId) {
        const tx = new Transaction();
        tx.moveCall({
     ...
     * @param botNftId - The Bot NFT object ID
     */
    async toggleLock(roleId, botNftId) {
        const tx = new Transaction();
        tx.moveCall({
     ...
     */
    async addSkill(roleId, botNftId, skillId) {
        const tx = new Transaction();
        tx.moveCall({
     ...
     */
    async removeSkill(roleId, botNftId, skillId) {
        const tx = new Transaction();
        tx.moveCall({
     ...
     */
    async withdrawSuiWithNft(roleId, botNftId, amount) {
        const tx = new Transaction();
        tx.moveCall({
     ...
     * @param amount - Amount of SUI to withdraw (in MIST)
     */
    async withdrawSuiAsBot(roleId, amount) {
        const tx = new Transaction();
        tx.moveCall({
